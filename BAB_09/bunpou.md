...
>
> **Kotoba yang masih dipakai dari Bab 1-8:** kata ganti orang & keluarga, profesi, makanan-minuman, kata sifat, kata kerja Te-form/Ta-form, waktu & tanggal.

⚠️ **Catatan kualitas:** Bab 9 di sumber asli menulis sebagian rumus dengan notasi "KK〜ます" padahal yang dimaksud adalah **STEM** (kata kerja yang ますnya sudah dibuang, BUKAN bentuk ます yang lengkap). Dokumen ini menuliskan ulang semua rumus dengan notasi yang konsisten dan jelas, plus satu koreksi typo di pola 【130】 (rumus di sumber asli ke-copy-paste salah dari pola 【129】).

---

## 🔑 KONSEP KUNCI: Apa itu STEM (Batang Kata Kerja)?

**STEM adalah kata kerja bentuk ます yang huruf ますnya SUDAH DIBUANG.** Bukan kata kerja mentah, bukan juga bentuk ます yang utuh — tapi "potongan tengah" di antara keduanya. STEM ini jadi semacam pasak yang bisa ditempeli banyak akhiran berbeda untuk membentuk makna baru, itulah kenapa Bab 9 ini isinya bejibun pola yang semuanya pakai fondasi yang sama.

### Cara membentuk STEM per golongan:

| Golongan | Contoh bentuk ます | STEM (ます dibuang) | Cara mengenali |
|---|---|---|---|
| **Golongan I** (Godan) | かきます, よみます, はなします | **かき**, **よみ**, **はなし** | Huruf terakhir STEM selalu berbunyi vokal **I** (baris い) |
| **Golongan II** (Ichidan) | たべます, みます, ねます | **たべ**, **み**, **ね** | Huruf terakhir STEM biasanya berbunyi vokal **E** (kadang I), tapi caranya sama: lepas ます saja |
| **Golongan III** (Fukisoku) | します, きます | **し**, **き** | Cuma 2 kata, wajib hafal langsung |

**Contoh konkret supaya jelas:**
- 飲みます (minum) → STEM = **飲み** (nomimasu → nomi)
- 食べます (makan) → STEM = **食べ** (tabemasu → tabe)
- 会います (bertemu) → STEM = **会い** (aimasu → ai)
- します (melakukan) → STEM = **し** (shimasu → shi)

Begitu STEM ini dipahami, semua 17 pola di bawah cuma soal "STEM + akhiran apa" — bukan hal baru yang harus dihafal satu-satu dari nol.

---

## GRUP A — STEM + Kata Kerja Gerak (Tujuan Bepergian)
...
> **Bedain 【125】 vs 【126】:** ませんか lebih sopan/menawarkan pilihan ("maukah kamu... kalau tidak ya tidak apa-apa"). ましょう lebih tegas mengajak ("ayo, kita lakukan ini").
...
Menolak: いいですよ・だいじょうぶです


---

## GRUP C — STEM + Cara Melakukan & Tingkat Kesulitan
...
## GRUP D — Menyatakan Keinginan (Hoshii & Tai)
...
> **Perbandingan penting KB vs KK untuk "ingin":** kalau objeknya KATA BENDA, pakai KB + が + ほしい(くない) です. Kalau objeknya KATA KERJA (aktivitas), pakai STEM + たい(くない) です. Dua-duanya ikut pola konjugasi KS-i (karena ほしい dan たい secara gramatikal berperilaku seperti kata sifat -i).

---

## GRUP E — Pola Tambahan: Acara, Kalimat Biasa & Penghubung
...
> **Tingkat formalitas kata "tapi":** が (paling netral/formal, Bab 5) → でも (netral, antar kalimat, Bab 5-6) → けど／けれど／けれども (dari paling kasual ke paling sopan — urutannya persis: けど paling santai, けれども paling sopan di antara ketiganya).
...
> **Tingkat formalitas:** じゃ (paling kasual) → それじゃ → それでは → では (paling formal, sering dipakai di awal/akhir presentasi atau kelas resmi).

---

## Ringkasan Peta Fungsi Bab 9
...
## Checklist Pemahaman Bab 9 (sebelum lanjut ke Bab 10)

Supaya Bab 9 ini benar-benar dikuasai, coba jawab sendiri pertanyaan berikut tanpa buka catatan:

1. Apa STEM dari 買います, 起きます, 勉強します? *(jawaban: 買い, 起き, 勉強し)*
2. Apa bedanya ませんか (【125】) dengan ましょうか (【127】)? *(jawaban: ませんか = mengajak bareng, ましょうか = menawarkan bantuan sepihak)*
3. Kalau ingin KATA BENDA pakai apa? Kalau ingin melakukan KATA KERJA pakai apa? *(jawaban: KB+が+ほしいです; STEM+たいです)*
4. Urutan formalitas kata "tapi" dari paling santai ke paling sopan? *(jawaban: けど → けれど → けれども, semuanya lebih kasual dari が/でも)*

Kalau semua bisa dijawab tanpa lihat catatan, berarti Bab 9 sudah benar-benar dikuasai dan siap lanjut ke Bab 10 (bentuk ～ない).
