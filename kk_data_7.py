...
CARDS = [
    {
        ...
        'ch': [('溜', 'た.まる', 'リュウ', '[Radikal: 氵 (Air)] + [Komponen: 留 (Tertahan)] = Air yang tertahan menumpuk.')],
    ...
    },
    {
        ...
        'ch': [('通', 'とお.る / かよ.う', 'ツウ', '[Radikal: 辶 (Jalan)] + [Komponen: 甬 (Tabung/Lorong)] = Berjalan menembus lorong.')],
    ...
    },
    {
        ...
        'ch': [('通', 'かよ.う', 'ツウ', '[Radikal: 辶 (Jalan)] + [Komponen: 甬 (Lorong)] = Melewati jalan yang sama berulang-ulang.')],
    ...
    },
    {
        ...
        'ch': [('迷', 'まよ.う', 'メイ', '[Radikal: 辶 (Jalan)] + [Komponen: 米 (Beras/Percabangan)] = Jalan yang bercabang membingungkan.')],
    ...
    },
    {
        ...
        'ch': [('戻', 'もど.す / もど.る', 'レイ', '[Radikal: 戸 (Pintu)] + [Komponen: 大 (Besar)] = Mendorong pintu besar kembali ke posisi semula.')],
    ...
    },
    {
        ...
        'ch': [('戻', 'もど.る', 'レイ', '[Radikal: 戸 (Pintu)] + [Komponen: 大 (Besar)] = Kembali ke balik pintu rumah.')],
    ...
    },
    {
        ...
        'ch': [('壊', 'こわ.す', 'カイ', '[Radikal: 土 (Tanah)] + [Komponen: 懐 (Kantong/Menghancurkan)] = Merobohkan bangunan tanah.')],
    ...
    },
    {
        ...
        'ch': [('壊', 'こわ.れる', 'カイ', '[Radikal: 壊 (Hancur)] = Benda yang rusak dengan sendirinya.')],
    ...
    },
    {
        ...
        'ch': [('空', 'あ.く / そら', 'クウ', '[Radikal: 穴 (Lubang)] + [Komponen: 工 (Pekerjaan/Alat)] = Lubang yang dikerjakan sampai kosong.')],
    ...
    },
    {
        ...
        'ch': [('行', 'おこな.う / い.く', 'コウ / ギョウ', '[Radikal: 行 (Pergi/Berjalan)] = Persimpangan jalan / Melaksanakan langkah.')],
    ...
    },
    {
        ...
        'ch': [('選', 'えら.ぶ', 'セン', '[Radikal: 辶 (Jalan)] + [Komponen: 巽 (Dua orang bersisian/Angin)] = Memilah dua jalur yang berbeda di persimpangan.')],
    ...
    },
    {
        ...
        'ch': [('外', 'はず.す / そと', 'ガイ', '[Radikal: 夕 (Malam)] + [Komponen: 卜 (Ramalan)] = Di luar / Meleset dari ramalan.')],
    ...
    },
    {
        ...
        'ch': [('要', 'い.る', 'ヨウ', '[Radikal: 覀 (Penutup kepala)] + [Komponen: 女 (Wanita)] = Hal penting yang dibutuhkan wanita (kebutuhan inti).')],
    ...
    },
    {
        ...
        'ch': [('離', 'はな.す', 'リ', '[Radikal: 隹 (Burung)] + [Komponen: 离 (Binatang aneh/Terpisah)] = Burung yang terlepas terbang menjauh.')],
    ...
    },
    {
        ...
        'ch': [('思', 'おも.う', 'シ', '[Radikal: 心 (Hati)] + [Komponen: 田 (Sawah/Otak)] = Pikiran dan perasaan hati.')],
    ...
    },
    {
        ...
        'ch': [('倒', 'たお.す', 'トウ', '[Radikal: 亻 (Orang)] + [Komponen: 到 (Sampai/Tiba)] = Orang yang dijatuhkan sampai rata tanah.')],
    ...
    },
    {
        ...
        'ch': [('流', 'なが.す', 'リュウ', '[Radikal: 氵 (Air)] + [Komponen: 㐬 (Anak lahir/Mengalir deras)] = Air yang mengalir deras.')],
    ...
    },
    {
        ...
        'ch': [('打', 'う.つ', 'ダ', '[Radikal: 扌 (Tangan)] + [Komponen: 丁 (Paku)] = Tangan memukul paku.')],
    ...
    },
    {
        ...
        'ch': [('逃', 'に.げる', 'トウ', '[Radikal: 辶 (Jalan)] + [Komponen: 兆 (Retak/Pecah)] = Berlari menjauhi retakan bahaya.')],
    ...
    },
    {
        ...
        'ch': [('足', 'た.す / あし', 'ソク', '[Radikal: 足 (Kaki)] = Kaki yang cukup/penuh. Menambah sesuatu agar cukup.')],
    ...
    },
    {
        ...
        'ch': [('分', 'わ.ける', 'ブン', '[Radikal: 刀 (Pisau)] + [Komponen: 八 (Membelah)] = Pisau membelah jadi dua bagian.')],
    ...
    },
    {
        ...
        'ch': [('生', 'い.きる / う.まれる', 'セイ', '[Radikal: 生 (Kehidupan)] = Tunas tanaman yang tumbuh dari tanah.')],
    ...
    },
    {
        ...
        'ch': [('消', 'け.す', 'ショウ', '[Radikal: 氵 (Air)] + [Komponen: 肖 (Menyerupai/Menipis)] = Air menyiram api sampai hilang.')],
    ...
    },
    {
        ...
        'ch': [('押', 'お.す', 'オウ', '[Radikal: 扌 (Tangan)] + [Komponen: 甲 (Perisai/Cangkang)] = Tangan mendorong perisai keras.')],
    ...
    },
    {
        ...
        'ch': [('引', 'ひ.く', 'イン', '[Radikal: 弓 (Busur)] + [Komponen: | (Tali)] = Menarik tali busur.')],
    ...
    },
    {
        ...
        'ch': [('開', 'ひら.く / あ.ける', 'カイ', '[Radikal: 門 (Gerbang)] + [Komponen: 幵 (Dua palang terbuka)] = Gerbang terbuka lebar.')],
