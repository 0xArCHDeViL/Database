...
CARDS = [
    {
        ...
        'ch': [('上', 'あ.げる / うえ', 'ジョウ', '[Radikal: 一 (Garis dasar)] + [Komponen: 卜 (Tongkat tegak ke atas)] = Di atas / Menaikkan.')],
    ...
    },
    {
        ...
        'ch': [('呉', 'く.れる', 'ゴ', '[Radikal: 口 (Mulut)] + [Komponen: 夨 (Kepala miring memohon)] = Mulut bersuara minta diberi.')],
    ...
    },
    {
        ...
        'ch': [('貰', 'もら.う', 'セイ', '[Radikal: 貝 (Uang)] + [Komponen: 世 (Generasi/Waktu yang lama)] = Menerima warisan uang/turun temurun.')],
    ...
    },
    {
        ...
        'ch': [('送', 'おく.る', 'ソウ', '[Radikal: 辶 (Jalan)] + [Komponen: 关 (Obor/Api di atas kayu)] = Berjalan malam membawa obor mengantar sesuatu.')],
    ...
    },
    {
        ...
        'ch': [('払', 'はら.う', 'フツ', '[Radikal: 扌 (Tangan)] + [Komponen: ム (Pribadi/Bentuk melengkung siku)] = Tangan yang mengusap bersih.')],
    ...
    },
    {
        ...
        'ch': [('頼', 'たの.む', 'ライ', '[Radikal: 頁 (Kepala)] + [Komponen: 束 (Buntelan/Kerang bertumpuk)] = Kepala bersandar pada harta/orang kuat.')],
    ...
    },
    {
        ...
        'ch': [('勤', 'つと.める', 'キン', '[Radikal: 力 (Tenaga)] + [Komponen: 堇 (Kuning tua/Keringat/Kerja keras)] = Mengeluarkan tenaga penuh.')],
    ...
    },
    {
        ...
        'ch': [
            ('間', 'ま / あいだ', 'カン', 'Ruang/Jeda waktu (Matahari 日 di sela Gerbang 門).'),
            ('合', 'あ.う', 'ゴウ', 'Cocok/Menyatukan.')
        ],
    ...
    },
    {
        ...
        'ch': [('遅', 'おく.れる / おそ.い', 'チ', '[Radikal: 辶 (Jalan)] + [Komponen: 犀 (Badak)] = Berjalan lambat seperti badak berat.')],
    ...
    },
    {
        ...
        'ch': [('勝', 'か.つ / まさ.る', 'ショウ', '[Radikal: 力 (Kekuatan)] + [Komponen: 朕 (Tubuh raja menyembul) -> 月+龹] = Kekuatan luar biasa mengatasi beban.')],
    ...
    },
    {
        ...
        'ch': [('負', 'ま.ける / お.う', 'フ', '[Radikal: 貝 (Harta)] + [Komponen: 刀 (Pisau) / ⺈] = Harta yang dipotong / dibawa pergi.')],
    ...
    },
    {
        ...
        'ch': [('咲', 'さ.く', 'ショウ', '[Radikal: 口 (Mulut/Tunas)] + [Komponen: 关 (Ujung atas mekar/tersenyum)] = Kuncup yang tersenyum.')],
    ...
    },
    {
        ...
        'ch': [('吹', 'ふ.く', 'スイ', '[Radikal: 口 (Mulut)] + [Komponen: 欠 (Menguap / Nafas besar)] = Mengeluarkan hembusan keras.')],
    ...
    },
    {
        ...
        'ch': [('晴', 'は.れる', 'セイ', '[Radikal: 日 (Matahari)] + [Komponen: 青 (Biru murni / Bersih)] = Matahari di langit yang bersih.')],
    ...
    },
    {
        ...
        'ch': [('曇', 'くも.る', 'ドン', '[Radikal: 日 (Matahari)] + [Komponen: 雲 (Awan)] = Matahari tertutup awan.')],
    ...
    },
    {
        ...
        'ch': [('治', 'なお.る / おさ.める', 'ジ / チ', '[Radikal: 氵 (Air)] + [Komponen: 台 (Panggung/Dasar)] = Banjir yang terkendali/diobati.')],
    ...
    },
    {
        ...
        'ch': [('直', 'なお.す / なお.る', 'チョク', '[Radikal: 目 (Mata)] + [Komponen: 乚 (Lurus) / 十 (Lurus sempurna)] = Melihat lurus tanpa melenceng.')],
    ...
    },
    {
        ...
        'ch': [('続', 'つづ.く', 'ゾク', '[Radikal: 糸 (Benang)] + [Komponen: 売 (Menjual / Melangkah lurus)] = Untaian benang tak terputus.')],
    ...
    },
    {
        ...
        'ch': [('続', 'つづ.ける', 'ゾク', '[Radikal: 続 (Lanjut)] = Membuat sesuatu berlanjut.')],
    ...
    },
    {
        ...
        'ch': [('集', 'あつ.まる', 'シュウ', '[Radikal: 隹 (Burung berekor pendek)] + [Komponen: 木 (Pohon)] = Kawanan burung di atas pohon.')],
    ...
    },
    {
        ...
        'ch': [('集', 'あつ.める', 'シュウ', '[Radikal: 集 (Kumpul)] = Subjek yang mengumpulkan.')],
    ...
    },
    {
        ...
        'ch': [('決', 'き.まる / き.める', 'ケツ', '[Radikal: 氵 (Air)] + [Komponen: 夬 (Tangan mematahkan/Membelah)] = Membelah tanggul agar air mengalir pasti.')],
    ...
    },
    {
        ...
        'ch': [('決', 'き.める', 'ケツ', '[Radikal: 決 (Putus)] = Mengambil keputusan mutlak.')],
    ...
    },
    {
        ...
        'ch': [('落', 'お.ちる', 'ラク', '[Radikal: 艹 (Rumput/Tanaman)] + [Komponen: 洛 (Hujan mendadak di kota)] = Daun yang berguguran ke bawah.')],
    ...
    },
    {
        ...
        'ch': [('落', 'お.とす', 'ラク', '[Radikal: 落 (Jatuh)] = Subjek dengan sengaja/ceroboh menjatuhkan benda.')],
