...
CARDS = [
    {
        ...
        'ch': [('下', 'さ.げる / した', 'カ / ゲ', '[Radikal: 一 (Garis dasar)] + [Komponen: 卜 (Tongkat ke bawah)] = Di bawah.')],
    ...
    },
    {
        ...
        'ch': [('辞', 'や.める', 'ジ', '[Radikal: 辛 (Pedas/Menderita)] + [Komponen: 舌 (Lidah)] = Lidah yang menyampaikan kata-kata perpisahan yang pedih.')],
    ...
    },
    {
        ...
        'ch': [('会', 'あ.う', 'カイ', '[Radikal: 𠆢 (Penutup/Atap)] + [Komponen: 云 (Awan/Berkumpul)] = Orang-orang berkumpul di bawah satu atap.')],
    ...
    },
    {
        ...
        'ch': [('合', 'あ.う', 'ゴウ', '[Radikal: 合 (Menyatu)] = Penutup wadah yang pas menutup mulut wadah.')],
    ...
    },
    {
        ...
        'ch': [
            ('結', 'むす.ぶ', 'ケツ', 'Mengikat (Benang 糸 + Keberuntungan 吉).'),
            ('婚', 'コン', 'コン', 'Pernikahan (Wanita 女 + Senja 昏).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('婚', 'コン', 'コン', 'Pernikahan.'),
            ('約', 'ヤク', 'ヤク', 'Janji/Kontrak (Benang 糸 + Sendok 勺 = ikatan perjanjian).')
        ],
    ...
    },
    {
        ...
        'ch': [('回', 'まわ.す', 'カイ', '[Radikal: 囗 (Kotak)] + [Komponen: 口 (Mulut/Pusat)] = Berputar mengelilingi pusat.')],
    ...
    },
    {
        ...
        'ch': [('無', 'な.い', 'ム / ブ', '[Radikal: 灬 (Api)] + [Komponen: 舞 (Menari)] = Api yang menari sampai semuanya lenyap terbakar.')],
    ...
    },
    {
        ...
        'ch': [
            ('思', 'おも.う', 'シ', 'Berpikir/Merasa (Otak 田 + Hati 心).'),
            ('出', 'だ.す', 'シュツ', 'Mengeluarkan.')
        ],
    ...
    },
    {
        ...
        'ch': [('動', 'うご.く', 'ドウ', '[Radikal: 力 (Tenaga)] + [Komponen: 重 (Berat)] = Tenaga untuk menggerakkan beban berat.')],
    ...
    },
    {
        ...
        'ch': [('吸', 'す.う', 'キュウ', '[Radikal: 口 (Mulut)] + [Komponen: 及 (Mencapai/Menarik)] = Mulut menarik udara masuk.')],
    ...
    },
    {
        ...
        'ch': [
            ('上手', 'うま.い / じょうず', 'ジョウズ', 'Mahir/Pandai (Tangan 手 di atas 上 = skill level atas).'),
        ],
    ...
    },
    {
        ...
        'ch': [('剥', 'む.く', 'ハク', '[Radikal: 刂 (Pisau)] + [Komponen: 录 (Mencakar)] = Pisau menguliti permukaan.')],
    ...
    },
    {
        ...
        'ch': [('渡', 'わた.る', 'ト', '[Radikal: 氵 (Air)] + [Komponen: 度 (Ukuran/Kali)] = Mengukur jarak sungai lalu menyeberanginya.')],
    ...
    },
    {
        ...
        'ch': [('曲', 'ま.がる', 'キョク', '[Radikal: 曲 (Bengkok)] = Piktogram sesuatu yang melengkung/tidak lurus.')],
    ...
    },
    {
        ...
        'ch': [('止', 'と.まる', 'シ', '[Radikal: 止 (Kaki berhenti)] = Piktogram jejak kaki yang berhenti melangkah.')],
    ...
    },
    {
        ...
        'ch': [('触', 'さわ.る', 'ショク', '[Radikal: 角 (Tanduk)] + [Komponen: 虫 (Serangga)] = Antena serangga yang menyentuh/meraba.')],
    ...
    },
    {
        ...
        'ch': [('点', 'つ.ける', 'テン', '[Radikal: 灬 (Api)] + [Komponen: 占 (Meramal/Titik)] = Menyalakan titik api.')],
    ...
    },
    {
        ...
        'ch': [('掛', 'か.ける', 'カイ', '[Radikal: 扌 (Tangan)] + [Komponen: 卦 (Gantungan/Tanda)] = Tangan menggantungkan benda.')],
    ...
    },
    {
        ...
        'ch': [('変', 'か.える', 'ヘン', '[Radikal: 変 (Berubah)] = Mengubah sesuatu secara aktif.')],
    ...
    },
    {
        ...
        'ch': [('降', 'お.ろす', 'コウ', '[Radikal: 阝 (Bukit)] + [Komponen: 夅 (Turun)] = Menurunkan benda dari ketinggian.')],
    ...
    },
    {
        ...
        'ch': [('返', 'かえ.す', 'ヘン', '[Radikal: 辶 (Jalan)] + [Komponen: 反 (Membalik)] = Berjalan membalik ke asal.')],
    ...
    },
    {
        ...
        'ch': [('汚', 'よご.す', 'オ', '[Radikal: 氵 (Air)] + [Komponen: 亏 (Menyimpang/Rusak)] = Air yang tercemar menyimpang dari kemurnian.')],
    ...
    },
    {
        ...
        'ch': [('汚', 'よご.れる', 'オ', '[Radikal: 汚 (Kotor)] = Benda yang menjadi kotor dengan sendirinya.')],
    ...
    },
    {
        ...
        'ch': [('無', 'な.い', 'ム', '[Radikal: 無 (Tidak ada)] = Berubah menjadi tidak ada.')],
    ...
    },
    {
        ...
        'ch': [('産', 'う.む', 'サン', '[Radikal: 生 (Lahir)] + [Komponen: 彦 (Orang berdiri) + 亠 (Penutup)] = Proses kelahiran yang agung.')],
    ...
    },
    {
        ...
        'ch': [('生', 'う.まれる', 'セイ', '[Radikal: 生 (Kehidupan)] = Tunas muncul dari tanah = lahir.')],
    ...
    },
    {
        ...
        'ch': [('慣', 'な.れる', 'カン', '[Radikal: 忄 (Hati)] + [Komponen: 貫 (Menembus)] = Hati yang sudah tertembus berkali-kali jadi kebal.')],
    ...
    },
    {
        ...
        'ch': [('掛', 'か.かる', 'カイ', '[Radikal: 扌 (Tangan)] + [Komponen: 卦 (Tanda gantung)] = Sesuatu yang tergantung sendiri.')],
    ...
    },
    {
        ...
        'ch': [('込', 'こ.む', 'コミ', '[Radikal: 辶 (Jalan)] + [Komponen: 入 (Masuk)] = Orang-orang masuk ke jalan secara bersamaan.')],
    ...
    },
    {
        ...
        'ch': [
            ('間', 'ま', 'カン', 'Ruang/Jeda (Matahari 日 di sela gerbang 門).'),
            ('違', 'ちが.う', 'イ', 'Berbeda (Berjalan 辶 ke arah berlawanan 韋).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('風邪', 'かぜ', '-', 'Flu / Masuk angin (Angin 風 + Jahat 邪).'),
            ('引', 'ひ.く', 'イン', 'Menarik.')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('病気', 'びょうき', '-', 'Penyakit (Sakit 病 + Energi 気).'),
            ('罹', 'かか.る', 'リ', 'Terjangkit/Dijerat (Jaring 罒 + Berduka 離).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('頭', 'あたま', 'ズ', 'Kepala (Kacang 豆 + Halaman 頁).'),
            ('痛', 'いた.い', 'ツウ', 'Sakit/Nyeri (Penyakit 疒 + Ditusuk 甬).')
        ],
    ...
    },
    {
        ...
        'ch': [('挫', 'くじ.く', 'ザ', '[Radikal: 扌 (Tangan)] + [Komponen: 坐 (Duduk/Jatuh)] = Tangan/kaki yang terjatuh terpelintir.')],
