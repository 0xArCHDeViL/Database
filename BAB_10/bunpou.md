...
>
> **Kotoba yang masih dipakai dari Bab 1-9:** seluruh kata ganti, keluarga, profesi, makanan, kata sifat, kata kerja (segala bentuk), waktu, dan angka dari bab-bab sebelumnya.

Bab 10 adalah **bab penutup** — isinya bentuk ～ない (kembaran kasual dari ～ません), lima cara menyatakan "harus/wajib", dan yang paling penting: **rangkuman Bentuk Biasa (Futsuukei)** yang menyatukan SEMUA pola konjugasi dari Bab 1 sampai Bab 10 jadi satu peta besar. Bab ini juga membenahi beberapa penjelasan konjugasi kata sifat yang di bab-bab awal masih kurang eksplisit.

---

## 🔑 KUNCI UTAMA 1: Bentuk ～ない (Nai-Form)

Bentuk negatif KASUAL dari kata kerja — kalau bentuk sopan pakai ～ません, versi akrab/santainya pakai ～ない. Ini kembaran dari bentuk ～る (Bab 8): sama-sama diturunkan dari bentuk ます, tapi arahnya ke negatif.

| Golongan | Akhiran ます | Perubahan ke ～ない | Contoh (ます→ない) | Arti |
|---|---|---|---|---|
| Grup I | 〜います (vokal I) | Ganti い jadi **あ** + ない | かきます→**かかない**, よみます→**よまない**, とります→**とらない**, はなします→**はなさない** | tidak menulis, tidak baca, tidak ambil, tidak bicara |
| Grup I (pengecualian) | いきます | いか + ない | いきます→**いかない** | tidak pergi |
| Grup II | 〜ます (apa saja) | Lepas ます, tambah ない | たべます→**たべない**, おきます→**おきない**, みます→**みない**, ねます→**ねない** | tidak makan, tidak bangun, tidak lihat, tidak tidur |
| Grup III | します | し + ない | します→**しない** | tidak melakukan |
| Grup III | きます | **こ** + ない | きます→**こない** | tidak datang |

> **⚠️ Pengecualian super penting:** きます (datang) berubah jadi **こない**, BUKAN きない! Ini satu-satunya kata kerja yang huruf vokalnya berubah total (dari き ke こ), bukan cuma nambah ない biasa.

### 📚 Bonus: Perubahan ～たい (Bab 9) ke Bentuk Negatif

| Bentuk | Perubahan | Contoh |
|---|---|---|
| ～たい (ingin) | Buang い, tambah くない | たべたい→**たべたくない**, いきたい→**いきたくない** |
| ～たかった (dulu ingin) | Buang い, tambah くなかった | たべたかった→**たべたくなかった** |

---

## GRUP A — Bentuk ～ない Dasar & Larangan
...
## GRUP B — Menyatakan Keharusan & Kewajiban (5 Cara Berbeda)
...
## GRUP C — Kendaraan, Durasi & Naik-Turun
...
## GRUP D — Bentuk Biasa (Futsuukei): Rangkuman Final Semua Konjugasi

Ini bagian TERPENTING Bab 10 — tabel yang menyatukan konjugasi dari SEMUA jenis kata (kata benda, kata sifat -i, kata sifat -na, kata kerja) yang sudah dipelajari sejak Bab 1. **Bentuk Biasa (futsuukei)** dipakai untuk situasi akrab (dengan teman, keluarga) atau sebagai anak kalimat, dan disingkat "f" di rumus-rumus setelahnya.

### 【151】Tabel Lengkap Bentuk Sopan vs Bentuk Biasa

| Jenis Kata | Sopan (sekarang) | Biasa/f (sekarang) | Sopan (lampau) | Biasa/f (lampau) |
|---|---|---|---|---|
| **KB** (positif) | KB です | KB **だ** | KB でした | KB **だった** |
| **KB** (negatif) | KB じゃないです | KB **じゃない** | KB じゃなかったです | KB **じゃなかった** |
| **KS-i** (positif) | KS-i です | KS-i (dipakai apa adanya, tanpa です) | KS-i かったです | KS-i **かった** |
| **KS-i** (negatif) | KS-i くないです | KS-i **くない** | KS-i くなかったです | KS-i **くなかった** |
| **KS-na** (positif) | KS-na です | KS-na **だ** | KS-na でした | KS-na **だった** |
| **KS-na** (negatif) | KS-na じゃないです | KS-na **じゃない** | KS-na じゃなかったです | KS-na **じゃなかった** |
| **KK** (positif) | KK〜ます | KK〜**る** (bentuk kamus, Bab 8) | KK〜ました | KK〜**た** (Bab 8) |
| **KK** (negatif) | KK〜ません | KK〜**ない** (Bab 10) | KK〜ませんでした | KK〜**なかった** |
...
> - Negatif lampau: buang い → tambah **くなかった** (contoh: たかい → たか + くなかった = たかくなかった)
> - Jadi keterangan cara: buang い → tambah **く** (contoh: たかい → たか + く = たかく, dipakai di なります/します Bab 5)
> - Bentuk sambung "dan": buang い → tambah **くて** (contoh: たかい → たか + くて = たかくて, dipakai di Bab 7)
>
...
- 明日、日本 に 行く。(Besok saya pergi ke Jepang. — KK biasa/bentuk kamus)
...
## GRUP E — Mengutip Pikiran, Perkataan & Yang Didengar
...
## GRUP F — Kata Tanya Universal & Partikel Penutup
...
| Kata Tanya + でも | Arti | Kata Tanya + か | Arti |
|---|---|---|---|
| なんでも | apapun | なにか | sesuatu |
| いつでも | kapanpun | いつか | suatu saat |
...
## Ringkasan Peta Fungsi Bab 10

| Grup | Fungsi Utama | Pola |
|---|---|---|
| A | Bentuk ～ない dasar & larangan | 141, 142, 143 |
| B | Menyatakan keharusan/kewajiban (5 nuansa berbeda) | 144, 145, 146, 147, 148 |
| C | Kendaraan & durasi waktu/biaya | 149, 150 |
| D | **Bentuk Biasa (Futsuukei) — rangkuman final semua konjugasi** | 151, 152 |
| E | Mengutip pikiran, perkataan & yang didengar | 153, 154, 155, 156 |
| F | Kata tanya universal & partikel penutup | 157, 158, 159, 160, 161 |

---

## 🎓 Penutup: Peta Besar Seluruh Perjalanan Bunpou

Sampai di titik ini, seluruh fondasi tata bahasa dari Bab 1-10 sudah saling terhubung menjadi satu sistem:

- **Bab 1-4**: fondasi kalimat dasar (です/じゃないです, partikel dasar, keberadaan, kepemilikan)
- **Bab 5**: kata sifat -i dan -na (2 sistem konjugasi berbeda yang dipakai terus-menerus)
...
- **Bab 9**: **STEM** (Akar Kata) — memotong `ます` (batang kata kerja tanpa ます) sebagai fondasi banyak pola sekaligus
