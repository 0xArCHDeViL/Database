...
CARDS = [
    ...
    },
    {
        ...
        'ch': [('茶', 'ちゃ / さ', 'チャ', '[Radikal: 艹 (Rumput)] + [Komponen: 余 (Sisa) / 人 (Orang) + 木 (Pohon)]')],
...

    {
        ...
        'ch': [('温', 'あたた(かい) / ぬる(い)', 'オン', '[Radikal: 氵 (Air)] + [Komponen: 昷 (Mangkuk hangat)]')],
    ...
    },
    {
        ...
        'ch': [('酸', 'す(っぱい)', 'サン', '[Radikal: 酉 (Botol arak)] + [Komponen: 夋 (Berjalan pelan)]')],
    ...
    },
    {
        ...
        'ch': [('塩', 'しお', 'エン', '[Radikal: 土 (Tanah)] + [Komponen: 臣 (Mata) + 皿 (Piring)]')],
...

    {
        ...
        'ch': [('深', 'ふか(い)', 'シン', '[Radikal: 氵 (Air)] + [Komponen: 罙 (Lubang dalam)]')],
    ...
    },
    {
        ...
        'ch': [('浅', 'あさ(い)', 'セン', '[Radikal: 氵 (Air)] + [Komponen: 戋 (Tombak kecil)]')],
    ...
    },
    {
        ...
        'ch': [('易', 'やさ(しい) / か(える)', 'エキ / イ', '[Radikal: 日 (Matahari)] + [Komponen: 勿 (Tidak/Berubah)]')],
...

    {
        ...
        'ch': [('大', 'おお(きい)', 'ダイ', '[Radikal: 大 (Besar/Orang merentangkan tangan)]'), ('人', 'ひと', 'ジン', '[Radikal: 人]')],
    ...
    },
    {
        ...
        'ch': [
            ('真', 'ま / まこと', 'シン', '[Radikal: 目 (Mata)] + [Komponen: 匕 (Sendok)]'),
            ('面', 'おもて', 'メン', '[Radikal: 面 (Wajah)]'),
            ('目', 'め', 'モク', '[Radikal: 目 (Mata)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('丁', '–', 'テイ', '[Radikal: 一 (Satu)] + [Komponen: 亅 (Kail)]'),
            ('寧', '–', 'ネイ', '[Radikal: 宀 (Atap)] + [Komponen: 心 (Hati) + 皿 (Piring) + 丁 (Paku)]')
        ],
    ...
    },
    {
        ...
        'ch': [('親', 'おや / した(しい)', 'シン', '[Radikal: 見 (Melihat)] + [Komponen: 亲 (Berdiri di pohon)]')],
...

    {
        ...
        'ch': [('楽', 'たの(しい) / らく', 'ガク / ラク', '[Radikal: 木 (Pohon)] + [Komponen: 白 (Putih) + 幺 (Benang kecil)]')],
    ...
    },
    {
        ...
        'ch': [('眠', 'ねむ(い)', 'ミン', '[Radikal: 目 (Mata)] + [Komponen: 民 (Rakyat)]')],
    ...
    },
    {
        ...
        'ch': [('恥', 'はじ / はず(かしい)', 'チ', '[Radikal: 心 (Hati)] + [Komponen: 耳 (Telinga)]')],
    ...
    },
    {
        ...
        'ch': [('苦', 'にが(い) / くる(しい)', 'ク', '[Radikal: 艹 (Rumput)] + [Komponen: 古 (Tua)]')],
    ...
    },
    {
        ...
        'ch': [
            ('心', 'こころ', 'シン', '[Radikal: 心]'),
            ('配', 'くば(る)', 'ハイ', '[Radikal: 酉 (Arak)] + [Komponen: 己 (Diri)]')
        ],
    ...
    },
    {
        ...
        'ch': [('嫌', 'きら(い) / いや', 'ケン / ゲン', '[Radikal: 女 (Perempuan)] + [Komponen: 兼 (Merangkap)]')],
    ...
    },
    {
        ...
        'ch': [
            ('可', '–', 'カ', '[Radikal: 可]'),
            ('哀', 'あわ(れ)', 'アイ', '[Radikal: 口 (Mulut)] + [Komponen: 衣 (Baju)]'),
            ('想', 'おも(う)', 'ソウ', '[Radikal: 心 (Hati)] + [Komponen: 相 (Bersama)]')
        ],
    ...
    },
    {
        ...
        'ch': [('正', 'ただ(しい)', 'セイ / ショウ', '[Radikal: 止 (Berhenti)] + [Komponen: 一 (Satu)]')],
    ...
    },
    {
        ...
        'ch': [('酷', 'ひど(い)', 'コク', '[Radikal: 酉 (Arak)] + [Komponen: 告 (Lapor)]')],
    ...
    },
    {
        ...
        'ch': [
            ('可', '–', 'カ', '[Radikal: 可]'),
            ('笑', 'わら(う)', 'ショウ', '[Radikal: 竹 (Bambu)] + [Komponen: 夭 (Muda)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('立', 'た(つ)', 'リツ', '[Radikal: 立 (Berdiri)]'),
            ('派', '–', 'ハ', '[Radikal: 氵 (Air)] + [Komponen: 𠂢 (Cabang)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('駄', '–', 'ダ', '[Radikal: 馬 (Kuda)] + [Komponen: 太 (Gemuk/Besar)]'),
            ('目', 'め', 'モク', '[Radikal: 目 (Mata)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('格', '–', 'カク', '[Radikal: 木 (Pohon)] + [Komponen: 各 (Masing-masing)]'),
            ('好', 'この(む)', 'コウ', '[Radikal: 女 (Perempuan)] + [Komponen: 子 (Anak)]')
        ],
...

    {
        ...
        'ch': [('若', 'わか(い)', 'ジャク', '[Radikal: 艹 (Rumput)] + [Komponen: 右 (Kanan)]')],
    ...
    },
    {
        ...
        'ch': [('詳', 'くわ(しい)', 'ショウ', '[Radikal: 言 (Kata)] + [Komponen: 羊 (Domba)]')],
    ...
    },
    {
        ...
        'ch': [('激', 'はげ(しい)', 'ゲキ', '[Radikal: 氵 (Air)] + [Komponen: 敫 (Terang)]')],
    ...
    },
    {
        ...
        'ch': [('暇', 'ひま', 'カ', '[Radikal: 日 (Matahari)] + [Komponen: 叚 (Pinjaman)]')],
    ...
    },
    {
        ...
        'ch': [
            ('有', 'あ(る)', 'ユウ', '[Radikal: 月 (Bulan/Daging)] + [Komponen: 𠂇 (Tangan kiri)]'),
            ('名', 'な', 'メイ', '[Radikal: 口 (Mulut)] + [Komponen: 夕 (Malam)]')
        ],
    ...
    },
    {
        ...
        'ch': [('盛', 'さか(ん) / も(る)', 'セイ / ジョウ', '[Radikal: 皿 (Piring)] + [Komponen: 成 (Menjadi)]')],
    ...
    },
    {
        ...
        'ch': [
            ('複', '–', 'フク', '[Radikal: 衤 (Pakaian)] + [Komponen: 复 (Kembali/Ganda)]'),
            ('雑', '–', 'ザツ', '[Radikal: 隹 (Burung)] + [Komponen: 九 (Sembilan) + 木 (Pohon)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('十', 'じゅう', 'ジュウ', '[Radikal: 十 (Sepuluh)]'),
            ('分', 'わ(ける)', 'ブン / フン', '[Radikal: 刀 (Pisau)] + [Komponen: 八 (Delapan)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('特', '–', 'トク', '[Radikal: 牛 (Sapi)] + [Komponen: 寺 (Kuil)]'),
            ('別', 'わか(れる)', 'ベツ', '[Radikal: 別]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('不', '–', 'フ', '[Radikal: 不]'),
            ('思', 'おも(う)', 'シ', '[Radikal: 思]'),
            ('議', '–', 'ギ', '[Radikal: 言 (Kata)] + [Komponen: 義 (Keadilan)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('無', 'な(い)', 'ム', '[Radikal: 灬 (Api)] + [Komponen: 𠂛 (Menari)]'),
            ('駄', '–', 'ダ', '[Radikal: 馬 (Kuda)] + [Komponen: 太 (Gemuk/Besar)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('邪', '–', 'ジャ', '[Radikal: 阝 (Kota)] + [Komponen: 牙 (Taring)]'),
            ('魔', '–', 'マ', '[Radikal: 鬼 (Hantu)] + [Komponen: 麻 (Ganja)]')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('適', '–', 'テキ', '[Radikal: 辶 (Jalan)] + [Komponen: 啇 (Akar/Pangkal)]'),
            ('当', 'あ(たる)', 'トウ', '[Radikal: 小 (Kecil)] + [Komponen: 彐 (Moncong)]')
        ],
