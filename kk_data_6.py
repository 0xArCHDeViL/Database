...
CARDS = [
    {
        ...
        'ch': [
            ('出', 'で.る', 'シュツ', 'Keluar (Tunas muncul dari tanah).'),
            ('来', 'く.る', 'ライ', 'Datang.')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('注', 'そそ.ぐ', 'チュウ', 'Menuangkan/Fokus (Air 氵 + Panah 主).'),
            ('意', 'イ', 'イ', 'Pikiran/Niat (Suara 音 + Hati 心).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('出', 'で.る', 'シュツ', 'Keluar.'),
            ('発', 'はつ', 'ハツ', 'Menembak/Memulai (Kaki 癶 + Busur 弓 = melepas anak panah).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('到', 'いた.る', 'トウ', 'Sampai (Pisau 刂 yang mencapai target).'),
            ('着', 'つ.く', 'チャク', 'Menempel/Sampai (Bulu domba 羊 menempel di tubuh 目).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('運', 'はこ.ぶ', 'ウン', 'Mengangkut (Kendaraan 車 + Jalan 辶).'),
            ('転', 'ころ.がる', 'テン', 'Berputar/Bergulir (Kendaraan 車 + Awan ス = roda berputar).')
        ],
    ...
    },
    {
        ...
        'ch': [
            ('出', 'で.る', 'シュツ', 'Keluar.'),
            ('張', 'は.る', 'チョウ', 'Membentang/Menegangkan (Busur 弓 + Panjang 長).')
        ],
    ...
    },
    {
        ...
        'ch': [('遣', 'や.る / つか.わす', 'ケン', '[Radikal: 辶 (Jalan)] + [Komponen: 遣 = Mengutus/Mengirim seseorang pergi di jalan.]')],
    ...
    },
    {
        ...
        'ch': [('学', 'まな.ぶ', 'ガク', '[Radikal: 子 (Anak)] + [Komponen: 臼 (Tangan meraba) + 冖 (Atap)] = Anak di bawah atap sekolah meraba ilmu.')],
    ...
    },
    {
        ...
        'ch': [('喜', 'よろこ.ぶ', 'キ', '[Radikal: 口 (Mulut)] + [Komponen: 壴 (Gendang/Musik)] = Mulut yang bernyanyi gembira diiringi gendang.')],
    ...
    },
    {
        ...
        'ch': [('変', 'か.わる', 'ヘン', '[Radikal: 夂 (Kaki terbalik)] + [Komponen: 言 (Kata) + 攵 (Pukulan)] = Kata-kata yang dipukul hingga terbalik / berubah bentuk.')],
    ...
    },
    {
        ...
        'ch': [('調', 'しら.べる', 'チョウ', '[Radikal: 言 (Kata)] + [Komponen: 周 (Keliling/Menyeluruh)] = Menanyai/menguji secara menyeluruh.')],
    ...
    },
    {
        ...
        'ch': [('受', 'う.ける', 'ジュ', '[Radikal: 又 (Tangan kanan)] + [Komponen: 冖 (Penutup) + 爪 (Cakar/Tangan atas)] = Tangan bawah menangkap barang dari tangan atas.')],
    ...
    },
    {
        ...
        'ch': [('弾', 'ひ.く / はず.む', 'ダン', '[Radikal: 弓 (Busur)] + [Komponen: 単 (Sederhana/Tunggal)] = Memetik tali busur tunggal.')],
    ...
    },
    {
        ...
        'ch': [('描', 'か.く / えが.く', 'ビョウ', '[Radikal: 扌 (Tangan)] + [Komponen: 苗 (Bibit tanaman/Pola)] = Tangan yang menorehkan pola.')],
    ...
    },
    {
        ...
        'ch': [
            ('旅', 'たび', 'リョ', 'Perjalanan (Bendera 方 + Orang 人 berarak).'),
            ('行', 'い.く', 'コウ', 'Pergi.')
        ],
    ...
    },
    {
        ...
        'ch': [('喋', 'しゃべ.る', 'チョウ', '[Radikal: 口 (Mulut)] + [Komponen: 葉 (Daun)] = Mulut yang bergoyang seperti daun tertiup angin.')],
    ...
    },
    {
        ...
        'ch': [('祈', 'いの.る', 'キ', '[Radikal: 礻 (Altar/Dewa)] + [Komponen: 斤 (Kapak)] = Memohon dengan kekuatan penuh di altar.')],
    ...
    },
    {
        ...
        'ch': [('迎', 'むか.える', 'ゲイ', '[Radikal: 辶 (Jalan)] + [Komponen: 卬 (Orang mendongak menunggu)] = Berjalan menjemput seseorang.')],
    ...
    },
    {
        ...
        'ch': [('殴', 'なぐ.る', 'オウ', '[Radikal: 殳 (Senjata/Tongkat)] + [Komponen: 区 (Wilayah/Kotak)] = Memukul target di wilayah tertentu.')],
    ...
    },
    {
        ...
        'ch': [('蹴', 'け.る', 'シュウ', '[Radikal: 足 (Kaki)] + [Komponen: 就 (Mendekati/Menuju)] = Kaki yang menghantam sasaran.')],
    ...
    },
    {
        ...
        'ch': [('味', 'あじ.わう', 'ミ', '[Radikal: 口 (Mulut)] + [Komponen: 未 (Belum matang)] = Mulut mencicipi buah yang belum matang untuk menguji rasanya.')],
