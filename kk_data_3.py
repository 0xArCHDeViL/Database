...
CARDS = [
    {
        ...
        'ch': [('持', 'も.つ', 'ジ', '[Radikal: 扌 (Tangan)] + [Komponen: 寺 (Kuil/Pejabat)] = Tangan memegang sesajen kuil.')],
    ...
    },
    {
        ...
        'ch': [('待', 'ま.つ', 'タイ', '[Radikal: 彳 (Jalan/Langkah)] + [Komponen: 寺 (Kuil/Tempat)] = Berhenti melangkah di kuil.')],
    ...
    },
    {
        ...
        'ch': [('呼', 'よ.ぶ', 'コ', '[Radikal: 口 (Mulut)] + [Komponen: 乎 (Seruan nafas/Teriakan)] = Mulut yang berseru nyaring.')],
    ...
    },
    {
        ...
        'ch': [('飛', 'と.ぶ', 'ヒ', '[Radikal: 飛 (Terbang)] = Piktogram dua sayap burung yang mengepak di atas udara.')],
    ...
    },
    {
        ...
        'ch': [('降', 'ふ.る / お.りる', 'コウ', '[Radikal: 阝 (Bukit/Langit)] + [Komponen: 夅 (Jejak kaki menurun)] = Benda yang turun dari atas.')],
    ...
    },
    {
        ...
        'ch': [('降', 'お.りる / ふ.る', 'コウ', '[Radikal: 阝 (Bukit/Tebing)] + [Komponen: 夅 (Jejak kaki turun)] = Kaki menapaki jalan turun.')],
    ...
    },
    {
        ...
        'ch': [('登', 'のぼ.る', 'トウ / ト', '[Radikal: 癶 (Dua kaki melangkah)] + [Komponen: 豆 (Altar pengorbanan)] = Kaki melangkah naik ke altar.')],
    ...
    },
    {
        ...
        'ch': [('入', 'はい.る / い.れる', 'ニュウ', '[Radikal: 入 (Masuk)] = Piktogram ujung panah / benda tajam menembus masuk.')],
    ...
    },
    {
        ...
        'ch': [('入', 'い.れる / はい.る', 'ニュウ', '[Radikal: 入 (Masuk)] = Memasukkan barang.')],
    ...
    },
    {
        ...
        'ch': [('出', 'で.る / だ.す', 'シュツ', '[Radikal: 凵 (Wadah/Lubang)] + [Komponen: 屮 (Tunas tanaman)] = Tunas muncul dari lubang tanah.')],
    ...
    },
    {
        ...
        'ch': [('出', 'だ.す / で.る', 'シュツ', '[Radikal: 出 (Keluar)] = Menarik objek ke luar.')],
    ...
    },
    {
        ...
        'ch': [('歩', 'ある.く', 'ホ / ブ', '[Radikal: 止 (Kaki berhenti)] + [Komponen: 少ない -> 步 (Kaki kiri dan kanan melangkah bergantian)] = Kaki melangkah perlahan.')],
    ...
    },
    {
        ...
        'ch': [('走', 'はし.る', 'ソウ', '[Radikal: 走 (Lari)] = Piktogram orang yang berlari sambil mengayunkan lengan sangat cepat.')],
    ...
    },
    {
        ...
        'ch': [('脱', 'ぬ.ぐ', 'ダツ', '[Radikal: 月 (Daging/Tubuh)] + [Komponen: 兌 (Membuka / Melepaskan)] = Membebaskan tubuh dari ikatan.')],
    ...
    },
    {
        ...
        'ch': [('着', 'き.る / つ.く', 'チャク', '[Radikal: 羊 (Bulu domba/Pakaian)] + [Komponen: 目 (Mata / Terlihat)] = Pakaian yang terlihat membalut badan.')],
    ...
    },
    {
        ...
        'ch': [('履', 'は.く', 'リ', '[Radikal: 尸 (Tubuh jongkok)] + [Komponen: 復 (Berulang/Jalan)] = Alas kaki untuk berjalan menopang tubuh.')],
    ...
    },
    {
        ...
        'ch': [('被', 'かぶ.る', 'ヒ', '[Radikal: 衤 (Pakaian)] + [Komponen: 皮 (Kulit luar / Menutupi)] = Pakaian yang menutupi bagian paling atas.')],
    ...
    },
    {
        ...
        'ch': [('閉', 'と.じる / し.める', 'ヘイ', '[Radikal: 門 (Gerbang)] = Gerbang yang ditutup rapat.')],
    ...
    },
    {
        ...
        'ch': [('歌', 'うた.う', 'カ', '[Radikal: 欠 (Buka mulut)] + [Komponen: 哥 (Nyanyian/Irama bersahutan)] = Mulut menganga mengeluarkan irama.')],
    ...
    },
    {
        ...
        'ch': [('踊', 'おど.る', 'ヨウ', '[Radikal: 足 (Kaki)] + [Komponen: 甬 (Tabung berongga / Melonjak)] = Kaki yang melompat mengikuti irama.')],
    ...
    },
    {
        ...
        'ch': [('泣', 'な.く', 'キュウ', '[Radikal: 氵 (Air)] + [Komponen: 立 (Berdiri tegak)] = Air mata yang tegak berdiri/mengucur.')],
    ...
    },
    {
        ...
        'ch': [('笑', 'わら.う', 'ショウ', '[Radikal: 竹 (Bambu)] + [Komponen: 夭 (Orang menari / meliuk)] = Suara tertawa mirip derik bambu / kelopak senyum (竹).')],
    ...
    },
    {
        ...
        'ch': [('怒', 'おこ.る', 'ド', '[Radikal: 心 (Hati)] + [Komponen: 奴 (Budak/Status rendah)] = Hati yang diperbudak emosi / Perasaan merendahkan orang.')],
    ...
    },
    {
        ...
        'ch': [('困', 'こま.る', 'コン', '[Radikal: 囗 (Pagar kurungan)] + [Komponen: 木 (Pohon)] = Pohon yang tumbuhnya terkurung kotak.')],
    ...
    },
    {
        ...
        'ch': [('急', 'いそ.ぐ', 'キュウ', '[Radikal: 心 (Hati/Perasaan)] + [Komponen: 刍 (Pisau membabat rumput liar)] = Hati yang dipaksa cepat.')],
