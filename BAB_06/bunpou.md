...
>
> **Kotoba yang masih dipakai dari Bab 1-5:** kata ganti orang & keluarga, profesi, makanan-minuman, kata sifat (Bab 5), angka & satuan, ruangan.

Bab 6 ini bab paling padat sejauh ini — gabungan tiga topik besar: (1) nyebut DI MANA dan KAPAN suatu kegiatan terjadi, (2) pola pergi-datang-pulang dengan macam-macam keterangan tambahan, dan (3) **bentuk lampau** untuk semua jenis kata (kata benda, kata kerja, dua jenis kata sifat). Bagian bentuk lampau ini krusial banget karena bakal dipakai terus-menerus mulai sekarang.

---

## GRUP A — Lokasi & Waktu Aktivitas
...
## GRUP B — Alasan, Rentang Waktu & Kesepakatan
...
> **Catatan tentang あるいて:** "jalan kaki" pakai bentuk ～て dari kata kerja 歩きます (ある**いて**), yang bermakna "dengan cara~". Ini bentuk ～て yang detailnya baru dibahas lengkap di Bab 7 — di sini cukup dihafal sebagai pengecualian ungkapan.
...
## GRUP D — Bentuk Lampau (Semua Jenis Kata)

Ini bagian paling penting di Bab 6: setiap jenis kata (KB, KK, KS-i, KS-na) punya bentuk lampau yang beda-beda. Tabel berikut merangkum semuanya sebelum masuk ke pola satu-satu.

### 🔑 Tabel Kunci: Bentuk Lampau per Jenis Kata

| Jenis Kata | Sekarang (positif) | Lampau (positif) | Sekarang (negatif) | Lampau (negatif) |
|---|---|---|---|---|
| **KB** (misal 雨) | 雨 です | 雨**でした** | 雨 じゃない です | 雨 **じゃなかった** です |
| **KK** (misal 食べます) | 食べます | 食べ**ました** | 食べません | 食べ**ません でした** |
| **KS-i** (misal 寒い) | 寒い です | 寒**かった** です | 寒くない です | 寒**くなかった** です |
| **KS-na** (misal 静か) | 静か です | 静か**でした** | 静か じゃない です | 静か **じゃなかった** です |

> **Koreksi penting:** rumus asli 【77】 tertulis "KS〜いかった" — ini penulisan yang membingungkan. Yang benar: buang huruf **い** di akhir kata sifat, lalu tambahkan **かった**. Contoh: さむ**い** → さむ + かった = さむ**かった**. Bentuk negatifnya: buang い, tambah くなかった → さむ**くなかった**.
...
## Ringkasan Peta Fungsi Bab 6

| Grup | Fungsi Utama | Pola |
|---|---|---|
| A | Lokasi & waktu aktivitas (で, に/ごろ, なんじ) | 64, 65, 66 |
| B | Alasan & rentang waktu (から, まで, kesepakatan) | 67, 68, 69 |
| C | Pergi-datang-pulang & keterangan tambahan | 70, 71, 72, 73 |
| D | Bentuk lampau (KB/KK/KS-i/KS-na) | 74, 75, 76, 77, 78 |
| E | Posisi spasial & kontras | 79, 80 |

**Tips latihan:** Grup D (bentuk lampau) adalah bagian TERPENTING Bab 6 — pastikan hafal tabel 4-jenis-kata di atas luar kepala, karena mulai bab ini dan seterusnya, hampir semua obrolan bakal butuh bentuk lampau buat cerita "kemarin ngapain aja". Coba latihan cerita rutinitas kemarin lengkap pakai keterangan waktu (昨日, 先週, dll dari database kotoba) + kata kerja lampau + kata sifat lampau dalam satu paragraf pendek.
