...
CARDS = [
    {
        ...
        'ch': [('違', 'ちが.う / ちが.い', 'イ', '[Radikal: 辶 (Jalan/Pergerakan)] + [Komponen: 韋 (Saling Membelakangi)] = Melangkah ke arah yang berlawanan / Menyimpang.')],
    ...
    },
    {
        ...
        'ch': [('来', 'く.る / き.ます / こ.ない', 'ライ', '[Radikal: 木 (Pohon/Kayu)] + [Komponen: 丷 (Gandum yang turun dari langit)] = Musim panen yang datang.')],
    ...
    },
    {
        ...
        'ch': [('住', 'す.む / す.まう', 'ジュウ', '[Radikal: 亻 (Orang)] + [Komponen: 主 (Tuan/Utama)] = Orang yang menjadi tuan di suatu tanah.')],
    ...
    },
    {
        ...
        'ch': [('食', 'た.べる / く.う', 'ショク / ジキ', '[Radikal: 飠(Makan/Makanan)] -> Berasal dari 亼 (Mengumpulkan) + 皀 (Wadah makanan/Butiran nasi wangi).')],
    ...
    },
    {
        ...
        'ch': [('飲', 'の.む', 'イン', '[Radikal: 飠(Makanan)] + [Komponen: 欠 (Kekurangan/Menguap/Buka Mulut)] = Buka mulut karena kurang asupan cairan.')],
    ...
    },
    {
        ...
        'ch': [('有', 'あ.る', 'ユウ / ウ', '[Radikal: 月 (Daging/Bulan)] + [Komponen: 𠂇 (Tangan Kanan)] = Tangan memegang sepotong daging.')],
    ...
    },
    {
        ...
        'ch': [('居', 'い.る', 'キョ', '[Radikal: 尸 (Tubuh jongkok/Pantat)] + [Komponen: 古 (Tua/Dulu/Tetap)] = Tubuh yang berdiam lama.')],
    ...
    },
    {
        ...
        'ch': [('為', 'ため / す.る', 'イ', '[Radikal: 灬 (Api)] (Sebenarnya piktogram tangan 爪 menuntun gajah untuk bekerja keras).')],
    ...
    },
    {
        ...
        'ch': [('働', 'はたら.く', 'ドウ', '[Radikal: 亻 (Orang)] + [Komponen: 動 (Bergerak)] = Orang yang banyak gerak/bekerja.')],
    ...
    },
    {
        ...
        'ch': [('買', 'か.う', 'バイ', '[Radikal: 貝 (Kerang/Uang kuno)] + [Komponen: 罒 (Jaring)] = Menjaring kerang/uang.')],
    ...
    },
    {
        ...
        'ch': [('売', 'う.る / う.れる', 'バイ', '[Radikal: 士 (Prajurit/Pria)] + [Komponen: 冖 (Tutup) + 儿(Kaki)] = Menyodorkan barang jualan.')],
    ...
    },
    {
        ...
        'ch': [('洗', 'あら.う', 'セン', '[Radikal: 氵 (Air)] + [Komponen: 先 (Duluan/Ujung)] = Air yang dibilas duluan.')],
    ...
    },
    {
        ...
        'ch': [('読', 'よ.む', 'ドク / トク', '[Radikal: 言 (Berkata/Kata-kata)] + [Komponen: 売 (Menjual/Menyebarkan)] = Menyebarkan kata-kata.')],
    ...
    },
    {
        ...
        'ch': [('遊', 'あそ.ぶ', 'ユウ', '[Radikal: 辶 (Jalan)] + [Komponen: 斿 (Benderan terbang/Melayang bebas)] = Jalan santai melayang-layang.')],
    ...
    },
    {
        ...
        'ch': [('泳', 'およ.ぐ', 'エイ', '[Radikal: 氵 (Air)] + [Komponen: 永 (Abadi/Lama)] = Berada lama di air.')],
    ...
    },
    {
        ...
        'ch': [('行', 'い.く / ゆ.く / おこな.う', 'コウ / ギョウ', '[Radikal: 行 (Jalan bersimpangan)] = Piktogram persimpangan jalan empat arah.')],
    ...
    },
    {
        ...
        'ch': [('帰', 'かえ.る / かえ.す', 'キ', '[Radikal: ⺕ (Tangan babi/Menyapu)] + [Komponen: 止 (Berhenti)] + 冖(Tutup) = Berhenti di tempat bernaung.')],
    ...
    },
    {
        ...
        'ch': [('書', 'か.く', 'ショ', '[Radikal: 曰 (Berkata/Mengucapkan)] + [Komponen: 聿 (Kuas)] = Mengucapkan via kuas.')],
    ...
    },
    {
        ...
        'ch': [('貸', 'か.す', 'タイ', '[Radikal: 貝 (Kerang/Uang)] + [Komponen: 代 (Pengganti/Sementara)] = Uang yang berpindah sementara.')],
    ...
    },
    {
        ...
        'ch': [('借', 'か.りる', 'シャク', '[Radikal: 亻 (Orang)] + [Komponen: 昔 (Zaman dulu)] = Orang yang mengambil untung dari sesuatu yang lampau.')],
    ...
    },
    {
        ...
        'ch': [('聞', 'き.く / き.こえる', 'ブン / モン', '[Radikal: 耳 (Telinga)] + [Komponen: 門 (Gerbang)] = Telinga di pintu gerbang.')],
    ...
    },
    {
        ...
        'ch': [('切', 'き.る', 'セツ / サイ', '[Radikal: 刀 (Pisau/Pedang)] + [Komponen: 七 (Angka 7 / Silang)] = Menyilangkan pisau.')],
    ...
    },
    {
        ...
        'ch': [('探', 'さが.す', 'タン', '[Radikal: 扌 (Tangan)] + [Komponen: 罙 (Ke dalam/Gua)] = Tangan merogoh ke dalam.')],
    ...
    },
    {
        ...
        'ch': [('死', 'し.ぬ', 'シ', '[Radikal: 歹 (Tulang belulang)] + [Komponen: 匕 (Orang rebahan)] = Orang yang jadi tulang belulang.')],
    ...
    },
    {
        ...
        'ch': [('使', 'つか.う', 'シ', '[Radikal: 亻 (Orang)] + [Komponen: 吏 (Petugas pemerintah)] = Memerintah orang.')],
    ...
    },
    {
        ...
        'ch': [('作', 'つく.る', 'サク / サ', '[Radikal: 亻 (Orang)] + [Komponen: 乍 (Kerah baju yang sedang dipotong pisau)] = Orang memotong sesuatu.')],
    ...
    },
    {
        ...
        'ch': [
            ('手', 'て', 'シュ', '[Radikal: 手 (Tangan)] = 5 jari tangan yang mengembang.'),
            ('伝', 'つた.わる / つた.う', 'デン', '[Radikal: 亻 (Orang)] + [Komponen: 云 (Awan/Kata-kata)] = Menyampaikan / Meneruskan.')
        ],
    ...
    },
    {
        ...
        'ch': [('取', 'と.る', 'シュ', '[Radikal: 耳 (Telinga)] + [Komponen: 又 (Tangan Kanan)] = Tangan mengambil telinga.')],
    ...
    },
    {
        ...
        'ch': [('習', 'なら.う', 'シュウ', '[Radikal: 羽 (Sayap/Bulu)] + [Komponen: 白 (Putih/Sinar matahari)] = Burung muda belajar terbang di bawah matahari.')],
    ...
    },
    {
        ...
        'ch': [('乗', 'の.る', 'ジョウ', '[Radikal: 禾 (Pohon)] + [Komponen: 北 (Bertentangan/Utara)] -> Piktogram orang yang memanjat pohon.')],
